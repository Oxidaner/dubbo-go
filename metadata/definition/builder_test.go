...
func TestConstraintsLiftedByTheSharedResolver(t *testing.T) {
	...
	t.Run(`m:"-" drops only that field`, func(t *testing.T) {
		...
		assert.Equal(t, map[string]string{"keep": "java.lang.String"}, properties)
		assert.NotContains(t, properties, "-",
			`m:"-" must not publish a field literally named "-"`)
	})

	t.Run("tag options are honored, not rejected", func(t *testing.T) {
		...
		assert.Equal(t, map[string]string{"name": "java.lang.String", "other": "java.lang.String"}, properties)
	...
	t.Run("non-ASCII field names round-trip", func(t *testing.T) {
		...
		assert.Equal(t, map[string]string{"ünicode": "java.lang.String"}, properties)
...
func TestRemainFieldIsNotPublished(t *testing.T) {
	...
	assert.Equal(t, map[string]string{"name": "java.lang.String"}, properties)
